...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.5.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.5.tar.bz2.sig
...
%prep
%setup -q -n gnupg-2.4.5
cd %{_builddir}/gnupg-2.4.5
%patch -P 1 -p1
pushd ..
cp -a gnupg-2.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709850508
