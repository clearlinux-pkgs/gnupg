...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.4.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.4.tar.bz2.sig
...
%prep
%setup -q -n gnupg-2.4.4
cd %{_builddir}/gnupg-2.4.4
%patch -P 1 -p1
pushd ..
cp -a gnupg-2.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706231662
