...
#
# Source0 file verified with key 0x549E695E905BA208
#
Name     : gnupg
Version  : 2.2.36
Release  : 82
...
%prep
%setup -q -n gnupg-2.2.36
cd %{_builddir}/gnupg-2.2.36
%patch1 -p1
pushd ..
cp -a gnupg-2.2.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657149535
...
cp %{_builddir}/gnupg-2.2.36/COPYING %{buildroot}/usr/share/package-licenses/gnupg/4bc05f7560e1e3ced08b71c93f10abe9e702c3ee
cp %{_builddir}/gnupg-2.2.36/COPYING.CC0 %{buildroot}/usr/share/package-licenses/gnupg/754becb73f3b288d7d8a62d8927a334cd38ac10b
cp %{_builddir}/gnupg-2.2.36/COPYING.GPL2 %{buildroot}/usr/share/package-licenses/gnupg/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnupg-2.2.36/COPYING.LGPL21 %{buildroot}/usr/share/package-licenses/gnupg/ac1b58bbd5bc11cacb7205718d620156ffd57c7e
cp %{_builddir}/gnupg-2.2.36/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/gnupg/bf58811df8e4261d540cc1872f42011872ca8f54
cp %{_builddir}/gnupg-2.2.36/COPYING.other %{buildroot}/usr/share/package-licenses/gnupg/366d4e13a65adbfd0f7972f4c8dc9891692e92e5
cp %{_builddir}/gnupg-2.2.36/tests/gpgscm/LICENSE.TinySCHEME %{buildroot}/usr/share/package-licenses/gnupg/ca474fc88304aab05401b27d158b3f9e0c1ffae6
pushd ../buildavx2/
%make_install_v3
popd
%make_install
