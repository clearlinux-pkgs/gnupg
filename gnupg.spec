...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.6.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.6.tar.bz2.sig
...
%setup -q -n gnupg-2.4.6
cd %{_builddir}/gnupg-2.4.6
%patch -P 1 -p1
pushd ..
cp -a gnupg-2.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730295109
