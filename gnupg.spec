...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.2.31.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.2.31.tar.bz2.sig
...
%prep
%setup -q -n gnupg-2.2.31
cd %{_builddir}/gnupg-2.2.31
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631806164
...
cp %{_builddir}/gnupg-2.2.31/COPYING %{buildroot}/usr/share/package-licenses/gnupg/4bc05f7560e1e3ced08b71c93f10abe9e702c3ee
cp %{_builddir}/gnupg-2.2.31/COPYING.CC0 %{buildroot}/usr/share/package-licenses/gnupg/754becb73f3b288d7d8a62d8927a334cd38ac10b
cp %{_builddir}/gnupg-2.2.31/COPYING.GPL2 %{buildroot}/usr/share/package-licenses/gnupg/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnupg-2.2.31/COPYING.LGPL21 %{buildroot}/usr/share/package-licenses/gnupg/ac1b58bbd5bc11cacb7205718d620156ffd57c7e
cp %{_builddir}/gnupg-2.2.31/COPYING.LGPL3 %{buildroot}/usr/share/package-licenses/gnupg/bf58811df8e4261d540cc1872f42011872ca8f54
cp %{_builddir}/gnupg-2.2.31/COPYING.other %{buildroot}/usr/share/package-licenses/gnupg/366d4e13a65adbfd0f7972f4c8dc9891692e92e5
cp %{_builddir}/gnupg-2.2.31/tests/gpgscm/LICENSE.TinySCHEME %{buildroot}/usr/share/package-licenses/gnupg/ca474fc88304aab05401b27d158b3f9e0c1ffae6
%make_install
%find_lang gnupg2
