...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.3.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.3.tar.bz2.sig
...
Patch2: backport-T6579-dirmngr-Enable-the-call-of-ks_ldap_help_variables-when-USE_LDAP.patch
...
%prep
%setup -q -n gnupg-2.4.3
cd %{_builddir}/gnupg-2.4.3
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnupg-2.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701961576
