...
Source0  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.2.37.tar.bz2
Source1  : https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.2.37.tar.bz2.sig
...
%prep
%setup -q -n gnupg-2.2.37
cd %{_builddir}/gnupg-2.2.37
%patch1 -p1
pushd ..
cp -a gnupg-2.2.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661369154
